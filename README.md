...
- **Revenue-First** — who pays, when, how much?  
- **Strategic Substrate** — does it create real leverage / optionality?

No invented buyers. No cope reframing. Just clarity.

### Quick Start
1. Classify your project (Step -1)  
2. Pick Mode A or B based on primary intent  
3. Run the checklist  
...
See [docs/discovery-mode.md](docs/discovery-mode.md)
...
#indiehacker #buildinpublic #SaaS #startups
